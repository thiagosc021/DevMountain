...
//CODE HERE
const youShouldwearString = 'one should wear a '
...
if(temperature >= 80 && rain) {
  console.log(youShouldwearString + ClothesType.Tshirt + ' and take an' + ClothesType.Umbrella)
} else if (temperature > 60 && temperature < 80 && rain) {
  console.log(youShouldwearString + ClothesType.RainJacket)
} else if (temperature <= 60 && rain) {
  console.log(youShouldwearString + ClothesType.Jacket + ' and carry an ' + ClothesType.Umbrella)
} else {
  console.log(youShouldwearString + ClothesType.Shorts)
}
...
/*
  ...
  Ex, on the first iteration it would log 1, 
...
/*
  ...
  Ex, on the first iteration it would log 10, 
...
//CODE HERE
while(z > 0){
  for(countDown = z; countDown > 0; countDown--) {
    console.log(z)
  }    
  z--
}